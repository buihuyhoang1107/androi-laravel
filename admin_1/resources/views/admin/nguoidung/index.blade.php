...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-4">
            ...
            <div class="col-sm-4">
                <form type="get" action="{{url('/search/Nguoidung')}}">
    ...
    <div class="container-fluid">
        ...
        <table class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <td><input type="submit" value="{{($value->action==1)?"Mở Khóa":"Khóa"}}" id="{{$value->id}}"
                        type="button"
                        class="{{($value->action==0)?"btn-action btn btn-outline-danger":"btn-action btn btn-outline-success"}}" />
                </td>
        ...
        <div class="row">
            ...
            <div class="col-sm-6"> {{$nguoidung->links()}}</div>
        </div>
    </div>
</section>
@endsection
...
$(".btn-action").on('click', function(e) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $(".btn-action#" + data.id).attr('class', (data.action == true) ?
                'btn-action btn btn-outline-success' : 'btn-action btn btn-outline-danger');
        },
        error: function() {
