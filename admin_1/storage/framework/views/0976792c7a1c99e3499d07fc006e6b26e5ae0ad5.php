...
<head>
	...
	<!-- Template CSS -->
	<link rel="stylesheet" href="<?php echo e(url('/assets/css/style-starter.css')); ?>">
...
<script src="<?php echo e(url('/assets/js/jquery-3.3.1.min.js')); ?>"></script> <!-- Common jquery plugin -->
<!--bootstrap working-->
...
<?php /**PATH D:\HK5\android\androi-laravel\admin_1\resources\views/welcome_admin.blade.php ENDPATH**/ ?>